        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
				...
				<a class="navbar-brand" href="../home.php" data-toggle="tooltip" data-placement="bottom" title="Back to Home"><img class="profile-img img-responsive img-centered " src="../images/icon_home2.png "
                    alt=""></a>
                <a class="navbar-brand" href="#page-top">Cash <small><?php echo $ledger;?></small></a>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form-group">
					<label for="kwit">No. Kwitansi:</label>
					<input type="text" id="kwit" placeholder="No. Kwitansi" class="form-control"/>
				</div>
				<div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form-group">
					<label for="update_kwit">No. Kwitansi:</label>
					<input type="text" id="update_kwit" placeholder="No. Kwitansi" class="form-control"/>
				</div>
				<div class="form-group">
...
<!-- Custom JS file -->
<script type="text/javascript" src="../js/acct/cash.js"></script>
