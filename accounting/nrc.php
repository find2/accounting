        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
				...
				<a class="navbar-brand" href="../home.php" data-toggle="tooltip" data-placement="bottom" title="Back to Home"><img class="profile-img img-responsive img-centered " src="../images/icon_home2.png "
                    alt=""></a>
                <a class="navbar-brand" href="#page-top">Neraca<small><?php echo $ledger;?></small></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li class="page-scroll">
						<div class="pull-right">
							<button class="btn btn-success btn-sm" data-toggle="modal" data-target="#" onclick="closing_month()">Closing Month</button>
						</div>
					</li>
					<li class="page-scroll">
						<div class="pull-right">
...
<!-- Custom JS file -->
<script type="text/javascript" src="../js/acct/nrc.js"></script>
