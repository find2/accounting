        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
				...
				<a class="navbar-brand" href="../../home.php" data-toggle="tooltip" data-placement="bottom" title="Back to Home"><img class="profile-img img-responsive img-centered " src="../../images/icon_home2.png "
                    alt=""></a>
                <a class="navbar-brand" href="#page-top">Invoice to Monarch</a>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="type_data">Data:</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="readRecords()">Show</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select name="monarch" id="monarch" class="form-control">
                        <option value=""> -- </option>                                    
                        <option value="1">Monarch Dalung</option>                                    
                        <option value="2">Monarch Candidasa</option>                                    
                        <option value="3">Monarch Singaraja</option>                                    
                        <option value="4">Monarch Gianyar</option>                                    
                        <option value="5">Monarch Negara</option>                                    
                    </select>
                </div>
                <div class="form-group">
                    <button class="btn btn-sm btn-success btn-block" onclick="addItem()">Add Item</button>
                </div>
                <!-- item content -->
                <div id="item_content">
                </div> 
...
<div class="modal fade" id="update_user_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                        <label for="u_title">Billing Title:</label>
                        <input type="text" id="u_title" placeholder="Title" class="form-control"/>
                    </div>
                    <div class="form-group">
                        <label for="u_monarch">Monarch:</label>
                        <select name="u_monarch" id="u_monarch" class="form-control">
                            <option value=""> -- </option>                                    
                            <option value="1">Monarch Dalung</option>                                    
                            <option value="2">Monarch Candidasa</option>                                    
                            <option value="3">Monarch Singaraja</option>                                    
                ...
                <div class="form-group">
                    <button class="btn btn-sm btn-success btn-block" onclick="u_addItem_new()">Add Item</button>
                </div>
                <!-- item content -->
                <div id="u_item_content">
                </div> 
            <!-- End Item Content -->
            </div>
            <div class="modal-footer">
...
<!-- Custom JS file -->
<script type="text/javascript" src="../../js/acct/shop/billing.js"></script>
