        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
				...
				<a class="navbar-brand" href="../home.php" data-toggle="tooltip" data-placement="bottom" title="Back to Home"><img class="profile-img img-responsive img-centered " src="../images/icon_home2.png "
                    alt=""></a>
                <a class="navbar-brand" href="#page-top">Master Item</a>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form-group">
					...
					<input type="text" id="code" placeholder="Item Code" class="form-control"/>
				</div>
			</div>
...
<div class="modal fade" id="update_user_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
					<label for="u_name">Item Name:</label>
					<input type="text" id="u_name" placeholder="Name" class="form-control"/>
				</div>				
				<div class="form-group">
					<label for="u_code">Item Code:</label>
					<input type="text" id="u_code" placeholder="Item Code" class="form-control"/>
				</div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
...
<!-- Custom JS file -->
<script type="text/javascript" src="../../js/acct/shop/item-master.js"></script>
