        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
				...
				<a class="navbar-brand" href="../../home.php" data-toggle="tooltip" data-placement="bottom" title="Back to Home"><img class="profile-img img-responsive img-centered " src="../../images/icon_home2.png "
                    alt=""></a>
                <a class="navbar-brand" href="#page-top">Stock Item</a>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            <label for="id_master">Item:</label>
                            <select name="id_master" id="id_master" class="form-control">
                                <option value=""> -- </option>        
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">    
                        ...
                        <input type="text" id="stock_name" placeholder="Name" class="form-control"/>
                    </div>
                </div>
				<div class="form-group">
					<label for="qty">Quantity:</label>
					<input type="text" id="qty" placeholder="0" class="form-control"/>
				</div>				
				<div class="form-group">
					<label for="buy">Purchase Price:</label>
					<input type="text" id="buy" placeholder="0" class="form-control"/>
				</div>
				<div class="form-group">
					<label for="sell">Selling Price:</label>
					<input type="text" id="sell" placeholder="0" class="form-control"/>
				</div>
                <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            <label for="u_id_master">Item:</label>
                            <select name="u_id_master" id="u_id_master" class="form-control">
                                <option value=""> -- </option>                                    
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">    
                        <label for="u_stock_name">Name:</label>
                        <input type="text" id="u_stock_name" placeholder="Name" class="form-control"/>
                    </div>
                </div>
				<div class="form-group">
					<label for="u_qty">Quantity:</label>
					<input type="text" id="u_qty" placeholder="0" class="form-control"/>
				</div>				
				<div class="form-group">
					<label for="u_buy">Purchase Price:</label>
					<input type="text" id="u_buy" placeholder="0" class="form-control"/>
				</div>
				<div class="form-group">
					<label for="u_sell">Selling Price:</label>
					<input type="text" id="u_sell" placeholder="0" class="form-control"/>
				</div>
                <div class="form-group">
                    <label for="u_id_supplier">Supplier:</label>
                    <select name="u_id_supplier" id="u_id_supplier" class="form-control">
                        <option value=""> -- </option>                                    
                    </select>
                </div>
            </div>
...
<!-- Custom JS file -->
<script type="text/javascript" src="../../js/acct/shop/item-stock.js"></script>
