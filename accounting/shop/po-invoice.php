        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
				...
				<a class="navbar-brand" href="../../home.php" data-toggle="tooltip" data-placement="bottom" title="Back to Home"><img class="profile-img img-responsive img-centered " src="../../images/icon_home2.png "
                    alt=""></a>
                <a class="navbar-brand" href="#page-top">PO - Invoice</a>
            </div>
...
<div class="modal fade" id="add_new_record_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Add Pre-Order Purchase</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
...
<div class="modal fade" id="update_user_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <div class="form-group">
                <label for="u_title">Order Title:</label>
...
<!-- Custom JS file -->
<script type="text/javascript" src="../../js/acct/shop/po-inv.js"></script>
