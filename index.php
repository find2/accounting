...
<body id="page-top" class="index">
        ...
        <div class="container">
            <!-- <div class="row">
                <div class="col-lg-12 text-center">
					<img class="profile-img img-responsive" src="images/yayasan.png" style="width:50%; height:50%;"
                    alt="">
                </div>
            </div> -->
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form name="loginForm"  action="login.php" method="post" role="form">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <button type="submit" class="btn btn-success btn-lg" name="login-btn" id="login-btn" >Login</button>
                            </div>
                        </div>
                    </form>
                </div>
	...
	<script type="text/javascript" src="js/instruktur.js"></script>
</body>
